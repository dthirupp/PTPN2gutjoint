...
phylo_rpca <- read.delim("/media/deepan/Deepan/RA_Bottini/final_merged_tables_forwardonly/afterFMT/phylo-ordination/ordination_coords.csv", header = TRUE, sep = "\t", check.names = FALSE)#only plotting PC1 and PC2. 

phylo_rpca <-  merge(phylo_rpca, metadata, by = "sample-ID", all.y = FALSE)

#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/MainFig1-phylorpca-patient.svg", height = 4, width = 4)
...
#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/MainFig1-phylorpca-MouseType.svg", height = 4, width = 4)
...
#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/MainFig1-phylorpca-beforeafterRA.svg", height = 4, width = 4)
...
uunifrac <- read.delim("/media/deepan/Deepan/RA_Bottini/final_merged_tables_forwardonly/afterFMT/core-metrics-results/unweighted_unifrac_pcoa_results/ordination_coords.csv", header = TRUE, sep = "\t", check.names = FALSE)#only plotting PC1 and PC2. 

uunifrac <-  merge(uunifrac, metadata, by = "sample-ID", all.y = FALSE)

#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/SuppFig1-uunifrac-Patient.svg", height = 4, width = 4)
...
#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/SuppFig1-uunifrac-MouseType.svg", height = 4, width = 4)
...
#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/SuppFig1-uunifrac-beforeafterRA.svg", height = 4, width = 4)
...
jacc <- read.delim("/media/deepan/Deepan/RA_Bottini/final_merged_tables_forwardonly/afterFMT/core-metrics-results/jaccard_pcoa_results/ordination_coords.csv", header = TRUE, sep = "\t", check.names = FALSE)#only plotting PC1 and PC2. 

jacc <-  merge(jacc, metadata, by = "sample-ID", all.y = FALSE)

#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/SuppFig1-jacc-Patient.svg", height = 4, width = 4)
...
#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/SuppFig1-jacc-MouseType.svg", height = 4, width = 4)
...
#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/SuppFig1-jacc-beforeafterRA.svg", height = 4, width = 4)
...
#svg("/home/deepan/Dropbox/Deepan-Only/UCSD/Zengler Lab/MiscellaneousExpts/RA-Bottini/Ppaer-figures/MainFig-ratio-genus-PrevotellatoBaceroides.svg", height = 3, width = 2)
